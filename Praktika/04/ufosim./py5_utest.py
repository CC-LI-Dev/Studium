...
from ufo_protocol import bbox
from ufo_protocol import protocol
...
# Nach dem Flug nach 20.0, 20.0 landet das Ufo nicht genau am Zielpunkt.
# Wenn trotzdem 20.0, 20.0 im Protokoll steht, wird nicht die tatsaechliche 
# Position sondern das Ziel in das Protokoll eingetragen.
assertNotEqual(protocol[-1][0], 20.0, "nach fly_to(sim, (20.0, 20.0), 10.0): protocol[-1][0]")
assertNotEqual(protocol[-1][1], 20.0, "nach fly_to(sim, (20.0, 20.0), 10.0): protocol[-1][1]")
...
assertAlmostEqual(protocol[-1][0], 1.1, 1e-3, "nach add_to_protocol((1.1, 2.2)): protocol[-1][0]")
assertAlmostEqual(protocol[-1][1], 2.2, 1e-3, "nach add_to_protocol((1.1, 2.2)): protocol[-1][1]")
assertEqual(len(protocol), l+1, "nach add_to_protocol((1.1, 2.2)): len(protocol)")

assertEqual(bbox([(0.0, 0.0), (55.0, 20.0), (-116.5, 95.0), (-10.0, -40.0), (-115.0, 95.0)], 10), (-120, 60, -40, 100), "bbox([(0.0, 0.0), (55.0, 20.0), (-116.5, 95.0), (-10.0, -40.0), (-115.0, 95.0)], 10)")
assertEqual(bbox([], 5), (0, 0, 0, 0), "bbox([], 5)")
assertEqual(bbox([(0.0, 0.0)], -2), (0, 0, 0, 0), "bbox([(0.0, 0.0)], -2)")
assertEqual(bbox([(0.0, 0.0)], 0), (0, 0, 0, 0), "bbox([(0.0, 0.0)], 0)")
assertEqual(bbox([(0.0, 0.0)], 1), (0, 0, 0, 0), "bbox([(0.0, 0.0)], 1)")
assertEqual(bbox([(10.1, -5.99), (5.5, 0.0)], 1), (5, 11, -6, 0), "bbox([(10.1, -5.99), (5.5, 0.0)], 1)")
assertEqual(bbox([(10.1, -5.99), (5.5, 0.0)], 5), (5, 15, -10, 0), "bbox([(10.1, -5.99), (5.5, 0.0)], 5)")
assertEqual(bbox([(10.1, -5.99), (5.0, 1.2), (6.1, 0.0)], 5), (5, 15, -10, 5), "bbox([(10.1, -5.99), (5.0, 1.2), (5.1, 0.0)], 5)")
assertEqual(bbox([(0.0, 0.0), (55.0, 20.0), (-116.5, 95.0), (-10.0, -40.0), (-115.0, 95.0)], 1), (-117, 55, -40, 95), "bbox([(0.0, 0.0), (55.0, 20.0), (-116.5, 95.0), (-10.0, -40.0), (-115.0, 95.0)], 1)")
assertEqual(bbox([(0.0, 0.0), (55.0, 20.0), (-116.5, 95.0), (-10.0, -40.0), (-115.0, 95.0)], 3), (-117, 57, -42, 96), "bbox([(0.0, 0.0), (55.0, 20.0), (-116.5, 95.0), (-10.0, -40.0), (-115.0, 95.0)], 3)")
